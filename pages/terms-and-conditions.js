...
export default function Terms() {
  return (
    <div className="p-32 px-8 md:px-96 ">
      <>
        <style
        ...
        <div data-custom-class="body">
                  ...
                  <span style={{ fontSize: 15 }}>
                    <span data-custom-class="body_text">
                      <span style={{ color: 'rgb(89, 89, 89)' }}>
                        ...
                        <bdt className="statement-end-if-in-editor" />
                        <bdt className="block-component" />{' '}
                        <bdt className="question">700020</bdt>
                        <bdt className="statement-end-if-in-editor" />
                      </span>
                    </span>
                  </span>
          ...
          <div align="center" style={{ textAlign: 'left' }}>
            ...
            >
              <bdt className="question">
                We provide a web application that lets you generate and curate
            ...
            >
              ...
              >
                ...
                phone at <bdt className="question">(+91)7003241095</bdt>, email
                at <bdt className="question">rangeenpalettes@gmail.com</bdt>
                <bdt className="block-component" />,
                <bdt className="statement-end-if-in-editor" /> or by mail to{' '}
                <bdt className="question">13A Justice Dwarkanath Road</bdt>
                <bdt className="block-component" />,{' '}
                <bdt className="question">Kolkata</bdt>
                <bdt className="block-component" />,{' '}
                <bdt className="question">West Bengal</bdt>
            ...
            >
              ...
              >
                ...
                <bdt className="statement-end-if-in-editor" />
                ), and <bdt className="question">Malay Vasa</bdt>, concerning
          ...
          <div align="center" style={{ textAlign: 'left' }}>
            ...
            >
              ...
              >
                ...
                <bdt className="question">rangeenpalettes@gmail.com</bdt>. If we
          ...
          <div align="center" style={{ textAlign: 'left' }}>
            ...
            >
              <span style={{ fontSize: 15 }}>
                ...
                <bdt className="question">rangeenpalettes@gmail.com</bdt>
                <bdt className="block-component" /> or call us at{' '}
                <bdt className="question">(+91)7003241095</bdt>
                <bdt className="statement-end-if-in-editor" />.
                <bdt className="statement-end-if-in-editor" />
              </span>
            </div>
          ...
          >
            ...
            >
              ...
              . <bdt className="question">Malay Vasa</bdt> and yourself
          ...
          >
            ...
            arbitrators shall be <bdt className="question">two (2)</bdt>. The
                      ...
                      >
                        <bdt data-type="conditional-block">
                          ...
                          <bdt data-type="body">
                            ...
                            <bdt className="block-component" />
                            <bdt className="question">500</bdt>
                            <bdt className="statement-end-if-in-editor" />
                          </bdt>
                        </bdt>
                      </bdt>
          ...
          >
            <strong>
              ...
              >
                <strong>
                  <bdt className="block-component" />
                  Phone: <bdt className="question">(+91)7003241095</bdt>
                  <bdt className="statement-end-if-in-editor" />
                </strong>
              </span>
            </strong>
